...
class IBoatTrajectoryData
{
    public:
        ...
        void readHurricaneFromFile(QString filePath);
        void readPortoTaxiFromFile(QString filePath);
        void readBerlinFromFile(QString filePath);   //Mazen
        void readBerlinFromFileK(QString filePath);   //Konarek
