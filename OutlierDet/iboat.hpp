...
class iBoat
{
    public:
        ...
        void loadIBoatHurricane(QString file);
        void loadIBoatPortoTaxi(QString file);
        void loadIBoatBerlin(QString file);
        void loadIBoatBerlinK(QString file);
        // start iBoat
    ...
    private:
        ...
        void process();
        // start detection over all data using inverted index
        void process_IVNIND();
        ...
        QList<TrajectoryIBoat *> *hasPathWindowOPT(QList<TrajectoryIBoat *> &workingSet, QList<CellIBoat *> window); //Konarek
};
